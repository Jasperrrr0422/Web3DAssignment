...
class Controller {
	...
	function apiCreateContentTable()
	{
		$contentData = $this->model->dbCreateContentTable();
		$this->load->view('viewMessage', $contentData);
	}
	...
	function apiInsertContentData(){
		$data = $this->model->dbInsertContentData();
		$this->load->view('viewMessage', $data);
	}
	function apiGetData()
	{
	...
	function apiGetContentData()
	{
		$ContentData = $this->model->dbgetContentdata();
		$this->load->view('view3DAppData', $ContentData);
	}
...

	{
		...
		$data1 = $this->model->dbgetContentdata();
		// $data = $this->model->dbGetData();
		...
		$this->load->view('viewCocaCola',$combinedData);
	...
	{
		$data = $this->model->dbGetData();
		$this->load->view('X3DModel', $data);
		echo json_encode($data);
	} 
	
	function apiGetContent(){
		$ContentData = $this->model->dbgetContentdata();
		$this->load->view('HomeImageCard', $ContentData);
